...
Напиши запрос, который выведет все колонки для серверов со статусом 'online', у которых нагрузка (load_avg) больше 2.0. Результат должен быть отсортирован по load_avg по убыванию.
Ожидаемый вывод:
Plaintext
...
SELECT *
FROM servers
WHERE status = 'online' AND load_avg > 2.0
